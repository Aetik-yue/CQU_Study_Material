...
HD_PWD='C:/Users/yanha/Desktop/Vivado project/project_1_1_nogate/project_1_1_nogate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log notgate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source notgate.tcl
