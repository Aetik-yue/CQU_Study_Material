...
HD_PWD='C:/Users/yanha/Desktop/Vivado project/project_1_1_nogate/project_1_1_nogate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log notgate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source notgate.tcl -notrace
