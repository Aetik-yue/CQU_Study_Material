...
HD_PWD='C:/Users/yanha/Desktop/Vivado project/project_1_3_mux4x3_verilogHDL/project_1_3_mux4x3_verilogHDL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux4x3_verilogHDL.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux4x3_verilogHDL.tcl -notrace
