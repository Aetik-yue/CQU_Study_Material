...
HD_PWD='C:/Users/yanha/Desktop/Vivado project/project_1_orgate/project_1_orgate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log orgate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source orgate.tcl
