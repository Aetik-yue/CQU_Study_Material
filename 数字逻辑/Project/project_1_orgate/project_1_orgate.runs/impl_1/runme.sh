...
HD_PWD='C:/Users/yanha/Desktop/Vivado project/project_1_orgate/project_1_orgate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log orgate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source orgate.tcl -notrace
