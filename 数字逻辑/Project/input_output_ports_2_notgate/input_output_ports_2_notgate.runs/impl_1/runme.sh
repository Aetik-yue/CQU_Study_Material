...
HD_PWD='C:/Users/yanha/Desktop/Vivado project/input_output_ports_2_notgate/input_output_ports_2_notgate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log notgate_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source notgate_2.tcl -notrace
