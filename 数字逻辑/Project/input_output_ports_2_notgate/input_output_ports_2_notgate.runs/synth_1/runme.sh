...
HD_PWD='C:/Users/yanha/Desktop/Vivado project/input_output_ports_2_notgate/input_output_ports_2_notgate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log notgate_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source notgate_2.tcl
