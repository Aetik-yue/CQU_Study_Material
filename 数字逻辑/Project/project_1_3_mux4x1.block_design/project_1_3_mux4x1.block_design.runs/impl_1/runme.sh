...
HD_PWD='C:/Users/yanha/Desktop/Vivado project/project_1_3_mux4x1.block_design/project_1_3_mux4x1.block_design.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux4x1_block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux4x1_block_wrapper.tcl -notrace
