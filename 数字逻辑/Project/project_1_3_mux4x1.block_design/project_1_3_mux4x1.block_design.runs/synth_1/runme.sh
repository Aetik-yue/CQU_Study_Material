...
HD_PWD='C:/Users/yanha/Desktop/Vivado project/project_1_3_mux4x1.block_design/project_1_3_mux4x1.block_design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux4x1_block_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux4x1_block_wrapper.tcl
