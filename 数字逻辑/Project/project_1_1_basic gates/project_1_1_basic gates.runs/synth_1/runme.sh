...
HD_PWD='C:/Users/yanha/Desktop/Vivado project/project_1_1_basic gates/project_1_1_basic gates.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log andgate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source andgate.tcl
