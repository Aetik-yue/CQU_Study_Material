...
HD_PWD='C:/Users/yanha/Desktop/Vivado project/project_1_1_basic gates/project_1_1_basic gates.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log andgate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source andgate.tcl -notrace
