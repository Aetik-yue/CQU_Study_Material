...
HD_PWD='C:/Users/yanha/Desktop/Vivado project/project_1_3_mux4x1_verilogHDL/project_1_3_mux4x1_verilogHDL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux4x1_verilogHDL.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux4x1_verilogHDL.tcl -notrace
